...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=mn5DUIxY#NVYY_1vVTVGwVl6nszzvOMMm46srX-mAVQ5UiLfepDw' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am ratta bot now!!*" : process.env.ALIVE_MSG,
